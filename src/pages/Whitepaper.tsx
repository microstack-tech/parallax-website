      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-row justify-end max-w-6xl w-full pb-8 mx-auto">
          <Button variant={'outline'} asChild>
            <Link to={"https://github.com/microstack-tech/parallax-whitepaper"} target="_blank">
              <FaGithub />
              View on Github
            </Link>
          </Button>
        ...
        <div className="flex flex-col gap-4 bg-card ring-4 max-w-6xl ring-muted/10 rounded-md border px-8 py-12 mx-auto items-start">
          <h1 className="scroll-m-20 text-center pb-12 text-4xl font-semibold tracking-tight text-balance">
