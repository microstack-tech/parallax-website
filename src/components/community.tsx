        ...
        <div className="mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-8 sm:grid-cols-2">
          <Card className="border-border hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              <Button variant="ghost" className="w-full justify-start" asChild>
                <Link to={"https://x.com/prlxchain"} target="_blank">
                  <FaXTwitter className="mr-2 h-4 w-4" />
                  Follow @prlxchain
                </Link>
              </Button>
              <Button variant="ghost" className="w-full justify-start" asChild>
                <Link to={"https://t.me/parallaxchain"} target="_blank">
          ...
          <Card className="border-border hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              ...
              <Button variant="ghost" className="w-full justify-start" asChild>
                <Link to={"https://github.com/microstack-tech/parallax"} target="_blank">
