          ...
          <Card className="border-border">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-border">
                ...
                <span className="text-primary">Proof of Work (Ethash)</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-border">
                <span className="text-sm text-muted-foreground">Block Interval</span>
                <span className="text-primary">600 seconds (10 minutes)</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-border">
                <span className="text-sm text-muted-foreground">Difficulty Adjustment</span>
                <span className="text-primary">2016 blocks (~2 weeks)</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-sm text-muted-foreground">Block Gas Limit</span>
                <span className="text-primary">600M gas (initial)</span>
              </div>
            </CardContent>
          </Card>
        </div>
