...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "metadata.introduction.protocol.architecture" })
  return pageMetadata({
    locale,
    path: "/introduction/protocol/architecture",
    title: t("title"),
    ...
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          { name: protocol("architecture.title"), path: "/introduction/protocol/architecture" },
        ]}
      />
      {children}
    </>
