...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "metadata.introduction.protocol.coinbaseMaturity" })
  return pageMetadata({
    locale,
    path: "/introduction/protocol/coinbase-maturity",
    title: t("title"),
    ...
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          { name: protocol("coinbaseMaturity.title"), path: "/introduction/protocol/coinbase-maturity" },
        ]}
      />
      {children}
    </>
