      ...
      <div className="mx-auto max-w-4xl px-6 sm:px-8 flex flex-col gap-16 pb-16">
        ...
        <section>
          <FadeIn>
            ...
            <blockquote className="mt-6 border-l-2 border-l-gold pl-4 font-serif italic text-lg text-foreground">
          ...
          <FadeIn delay={0.05}>
            <div className="mt-6 flex flex-col gap-6">
              <div className="border border-border border-l-2 border-l-gold bg-card/50 px-4 py-3">
        ...
        <section>
          <FadeIn>
            <div className="border border-border border-l-2 border-l-gold bg-card/50 p-6 sm:p-8">
              ...
              <Button className="mt-6 w-full sm:w-fit bg-gold text-gold-foreground hover:bg-gold/90" asChild>
