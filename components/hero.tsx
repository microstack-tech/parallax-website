  ...
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col h-full w-full px-6 sm:px-8 items-center z-[3]">
        ...
        >
          <Button size={"2xl"} className="w-full max-w-[15rem] px-6 bg-gold text-gold-foreground hover:bg-gold/90" asChild>
            <Link href={"/participate/running-a-full-node"}>
              Run a node
            </Link>
          </Button>
          <Button size={"2xl"} variant={"secondary"} className="w-full border border-white/20 max-w-[15rem] px-6 bg-white/5 text-white hover:bg-white/10" asChild>
